<template>
    <div class="component">
        <div id="bracket" class="container-fluid">
            <div class="row justify-content-start">
                ...
                <div class="round-2-left mycol-1">
                ...
                <div class="round-3-left mycol-1">
                ...
                <div class="round-4-left mycol-1">
                ...
                <div class="round-4-right right mycol-1">
                    <div class="round-4-offset"></div>
                    <div v-for="(match, index) in 1" v-bind:key="index" class="match round4 row">
                        <!--<div :class="'m'+index" class="match"> -->
                ...
                <div class="round-3-right right mycol-1">
                    <div class="round-3-offset"></div>
                    <div v-for="(match, index) in 2" v-bind:key="index" class="match round3 row">
                        <!--<div :class="'m'+index" class="match"> -->
                ...
                <div class="round-2-right right mycol-1">
                    <div class="round-2-offset"></div>
                    <div v-for="(match, index) in 4" v-bind:key="index" class="match round2 row">
                        <!--<div :class="'m'+index" class="match"> -->
    ...
    export default{
        data:function(){
            return{
                teams:[
                    ["Duke",96.3,0,1],
                    ["North Dakota State",70.35,0,16],
                    ["Virginia Commonwealth",82.23,0,8],
                    ["Central Florida",81.72,0,9],
                    ["Mississippi State",86.44,0,5],
                    ["Liberty",78.01,0,12],
                    ["Virginia Tech",88.74,0,4],
                    ["Saint Louis",77.35,0,13],
                    ["Maryland",84.84,0,6],
                    ["Belmont",81.06,0,11],
                    ["Louisiana State",86.41,0,3],
                    ["Yale",76.89,0,14],
                    ["Louisville",85.9,0,7],
                    ...
                    ["Baylor",82.71,0,9],
                    ["Marquette",85.31,0,5],
                    ["Murray State",81.29,0,12],
                    ["Florida State",88.39,0,4],
                    ["Vermont",79.29,0,13],
                    ["Buffalo",85.75,0,6],
                    ["Arizona State",80.87,0,11],
                    ["Texas Tech",89.65,0,3],
                    ["Northern Kentucky",77.25,0,14],
                    ["Nevada",86.12,0,7],
                    ["Florida",83.95,0,10],
                    ["Michigan",91.13,0,2],
                    ["Montana",76.19,0,15],
                    ...
                    ["Washington",82.55,0,9],
                    ["Auburn",88.65,0,5],
                    ["New Mexico State",80.91,0,12],
                    ["Kansas",86.3,0,4],
                    ["Northeastern",78.58,0,13],
                    ["Iowa State",86.16,0,6],
                    ["Ohio State",82.59,0,11],
                    ["Houston",88.13,0,3],
                    ["Georgia State",76.13,0,14],
                    ["Wofford",84.38,0,7],
                    ["Seton Hall",82.18,0,10],
                    ["Kentucky",91.24,0,2],
                    ["Abilene Christian",72.33,0,15]
                ],
                matches:[],
                round2:[],
                round3:[],
        ...
        methods:{
            test(){
                for(var i =0; i < 64; i=i+2){
                    var hold = [];
                    hold.push(this.teams[i],this.teams[i+1]);
                    this.matches.push(hold);
                }
            ...
            simFirstRound(){
                ...
                for(var i =0; i < 32; i=i+2){
                    var hold = [];
                    var odds = 1/(1+10**((-(this.matches[i][0][1]-this.matches[i][1][1]))*30.464/400));
                    ...
                    hold.push(this.matches[i][win],this.matches[i+1][win2]);
                    this.round2.push(hold)
                    if(win==0){
                        this.matches[i][0][2]++;
                    }
                    else{
                    ...
                    if(win2==0){
                        this.matches[i+1][0][2]++;
                    }
                    else{
                        this.matches[i+1][1][2]++;
                    }
